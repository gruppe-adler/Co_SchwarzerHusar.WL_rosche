...
["grad_drop_jm0"] remoteExec ["playSound",_units,false];
...
["grad_drop_jm1"] remoteExec ["playSound",_units,false];

sleep 5;

["grad_drop_jm2"] remoteExec ["playSound",_units,false];

sleep 10;

["grad_drop_jm3"] remoteExec ["playSound",_units,false];
...
["grad_drop_jm4"] remoteExec ["playSound",_units,false];
...
["grad_drop_jm5"] remoteExec ["playSound",_units,false];
...
["grad_drop_jm6"] remoteExec ["playSound",_units,false];
