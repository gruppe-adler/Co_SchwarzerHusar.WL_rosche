...
params ["_units","_plane","_soundPlane","_jm","_planeLights","_waitBeforeJump","_onLanding", "_identifier"];
_planeLights params ["_lightWhite","_lightGreen","_lightRed"];

sleep _waitBeforeJump;

[_units,_plane,_onLanding] remoteExec ["grad_drop_fnc_jump",_units,false];

[_jm,"grad_drop_jm0",_units] remoteExec ["grad_drop_fnc_playSound",_units,false];
...
[_jm,"grad_drop_jm1",_units] remoteExec ["grad_drop_fnc_playSound",_units,false];

sleep 5;

[_jm,"grad_drop_jm2",_units] remoteExec ["grad_drop_fnc_playSound",_units,false];

sleep 10;

[_jm,"grad_drop_jm3",_units] remoteExec ["grad_drop_fnc_playSound",_units,false];
...
[_jm,"grad_drop_jm4",_units] remoteExec ["grad_drop_fnc_playSound",_units,false];
...
[_plane, _units] spawn {
    ...
    for "_i" from 0 to 120 do {
        ...
        [_position, _delay, _strength] remoteExec ["GRAD_drop_fnc_spawnAA", _units,false];
        sleep _delay;
    };
};

[_jm,"grad_drop_jm5",_units] remoteExec ["grad_drop_fnc_playSound",_units,false];

sleep 15;

[_jm,"grad_drop_rearDoor",_units] remoteExec ["grad_drop_fnc_playSound",_units,false];
...
[_jm,"grad_drop_jm6",_units] remoteExec ["grad_drop_fnc_playSound",_units,false];
...
[_units, _plane] spawn {
    ...
    {
        if (!(isPlayer _x)) then {
            [_x, _plane] call grad_drop_fnc_jumpAI;
            sleep (random 2 + 1);
        };
    } forEach _units;
};
