...
["grad_drop_jm0",_units] remoteExec ["grad_drop_fnc_playSound",0,false];
...
["grad_drop_jm1",_units] remoteExec ["grad_drop_fnc_playSound",0,false];

sleep 5;

["grad_drop_jm2",_units] remoteExec ["grad_drop_fnc_playSound",0,false];

sleep 10;

["grad_drop_jm3",_units] remoteExec ["grad_drop_fnc_playSound",0,false];
...
["grad_drop_jm4",_units] remoteExec ["grad_drop_fnc_playSound",0,false];
...
["grad_drop_jm5",_units] remoteExec ["grad_drop_fnc_playSound",0,false];
...
["grad_drop_jm6",_units] remoteExec ["grad_drop_fnc_playSound",0,false];
